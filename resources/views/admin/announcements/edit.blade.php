...
<div class="max-w-2xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-lg font-semibold text-slate-800">Edit Pengumuman</h1>
    </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="body" rows="5" required
                              class="w-full border border-slate-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-400 transition @error('body') border-red-400 @enderror">{{ old('body', $announcement->body) }}</textarea>
                ...
                <div>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="pinned" value="1" {{ old('pinned', $announcement->pinned) ? 'checked' : '' }} class="w-4 h-4 rounded border-slate-300 text-blue-600 focus:ring-2 focus:ring-blue-500/30">
