            ...
            <div class="space-y-4" x-data="{ preview: null }">
                ...
                <div>
                    ...
                    <div class="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center hover:border-slate-400 transition cursor-pointer" @click="$refs.imageInput.click()">
                        ...
                        <p class="text-sm text-slate-600 font-medium">Klik atau drag gambar di sini</p>
                ...
                <div>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active') ? 'checked' : '' }} class="w-4 h-4 rounded border-slate-300 text-blue-600 focus:ring-2 focus:ring-blue-500/30">
